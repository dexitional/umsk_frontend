    ...
    <div className="flex flex-col space-y-1">
        ...
        <div className="px-3 py-2 opacity-80 md:opacity-100 flex rounded-md border bg-white items-center md:justify-start space-x-2 group">
          ...
          <div className="flex items-center justify-center space-x-3 text-center">
              <Link to={`/fms/payments/${data.id}`} title="Print Receipt" className={`bg-amber-800/70 py-0.5 px-2 rounded flex items-center space-x-1.5 text-sm text-white font-semibold`}>
                 <TbPrinter className="h-5 w-5" />
              </Link>
