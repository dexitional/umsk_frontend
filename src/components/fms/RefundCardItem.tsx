...
// Clone of ChargeCardItem for the opposite-effect Refund module -- same
// layout, a green accent on the amount footer to signal credit rather than
// debit.
function RefundCardItem({ data }: Props) {
      ...
      <div className="flex flex-col space-y-1">
        <div className="px-3 py-2 opacity-80 md:opacity-100 flex rounded-md border bg-white items-center md:justify-start space-x-2 group">
          ...
          <div className="hidden md:flex md:group-hover:hidden items-center justify-center space-x-3 text-center">
            <span
              className={`bg-emerald-600/80 py-0.5 px-2 rounded flex items-center space-x-1.5 text-sm text-white font-semibold`}
            >
              REFUND
            </span>
