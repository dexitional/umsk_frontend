  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-col md:flex-row md:items-center md:space-x-6 md:space-y-0 space-y-2">
        <h1 className="py-0.5 px-2 w-fit bg-slate-100 border-r-8 border-blue-950/70 rounded-md text-[0.65rem] md:text-xs font-semibold text-blue-950/70 uppercase">
          {page}
        </h1>
        <h1 className="text-[0.6rem] md:text-lg font-medium text-blue-950/70 uppercase tracking-wider">
          {title}
        </h1>
      </div>
