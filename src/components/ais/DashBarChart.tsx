  ...
  return (
    <div className="space-y-4">
      ...
      {/* overflow-x-auto + w-max min-w-full (not flex-1 columns): flex-1 sets
          ...
          floors it at its label's content width regardless of the
          grow/shrink math, so with enough categories the row's real content
          silently overflows past the card into whatever sits next to it
          instead of shrinking. Fixed-width shrink-0 columns in a
