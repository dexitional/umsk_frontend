...
const StaffIDCard = forwardRef(({data}:any,ref: any) => {
  return (
    <div ref={ref} style={{ width:'85mm',height:'54mm',border:'1px solid #eee', borderTop:'6px solid #aacce1' }}>
        <div style={{ padding:'7px 10px',display:'flex', flexDirection:'row' }}>
            ...
            <div style={{ flex:'1',display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center',textAlign:'center',lineHeight:'10px', gap:'-5px'}}>
                <h1 style={{ margin:'0', color:'black',font:'bolder 18px arial'}}>AKATSI </h1>
                <h2 style={{ margin:'0', color:'black', font:'normal 13px arial' }}>COLLEGE OF EDUCATION</h2>
                <h2 style={{ margin:'0', color:'black', font:'bold 10px arial' }}>( AKATSICO )</h2>
            </div>
        </div>
        <div style={{ marginBottom:'10px',borderBottom:'6px solid #29688e',display:'flex'}}>
            <div style={{ padding:'2px',width:'34%', height:'118px', background:'#29688e' }}>
            ...
            <div style={{ width:'100%', display:'flex',flexDirection:'column', background:'#fff'}}>
                <div style={{ padding:'4px', width: '100%', font:'bolder 10px arial', color: '#fff', textAlign:'center', letterSpacing:'0.1em', borderTop:'2px solid #29688e', borderBottom:'2px solid #29688e', background:'#333' }}>
                ...
                <div style={{ flex:'1', padding:'0px 5px', display:'flex', flexDirection:'column', gap:'-2px' }}>
                    ...
                    <div style={{ display:'flex', flexDirection:"row", justifyContent:"space-between", textAlign:'left' }}>
                      <div style={{ margin:'3px 4px', font:'bold 9px tahoma', color:'#000'}}><span style={{ font:'bold 9px arial',color:'#29688e'}}>INDEX NO </span><br/>{ data && data.indexno }</div>
                      <div style={{ margin:'3px 6px', font:'bold 9px tahoma', color:'#000'}}><span style={{ font:'bold 9px arial',color:'#29688e'}}>STUDENT ID </span><br/>{ data && data.refno }</div>
                      <div style={{ margin:'3px 4px', font:'bold 9px tahoma', color:'#000', textAlign:'center' }}><span style={{ font:'bold 9px arial',color:'#29688e'}}>SEX</span><br/>{ data && data.gender }</div>
