...
function DefermentShims({}: Props) {
  ...
  return (
    <div className="md:pl-10 p-4 md:p-6 space-y-4 md:space-y-10">
      <PageTitleShims title="Deferments" createtext="New" createlink="create"  />
      <div className="">
         { view == 'card' && (
            <div className="grid md:grid-cols-3 gap-3 md:gap-6">
                ...
                <div key={i} className="p-4 md:p-6 min-h-max border border-slate-200 rounded-xl bg-slate-50/50 space-y-7 animate-pulse delay-75">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="w-full flex items-center justify-between space-x-2 transition-all animate-pulse">
                            <div className="w-1/4 h-5 bg-gray-200 rounded-lg"></div>
                            <div className="w-2/5 h-5 bg-gray-200 rounded-lg"></div>
                        </div>
                    </div>
