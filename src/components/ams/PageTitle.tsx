...
function PageTitle({
  ...
  // Debounce: only push the typed keyword into the URL (and thus trigger the
  // query refetch) after the user pauses typing, so the loading state doesn't
  // interrupt/unmount the input on every keystroke.
  useEffect(() => {
