...
import AISGraduateIssueStudentCard from "../../components/ais/AISGraduateIssueStudentCard";
...
function PgAISGraduateSessionStudentIssue({}: Props) {
...
export default PgAISGraduateSessionStudentIssue;
