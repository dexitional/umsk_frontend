            ...
            {active === "faq" && (
              <section className="gd-page-section gd-active">
                ...
                <FaqGroup title="Academics" query={q} items={[
                  ...
                  ["A batch Upload said some students' email/access setup failed — are those students still created?", "Yes — the upload itself is all-or-nothing (every row lands or none do), but email generation and account staging run per-student right after, and a toast lists any that failed. Open that student's record and use Generate Student Email / Stage Account on their Account Management tab to finish setup manually."],
                ]} />
